import logo from '@/images/clients/brandecation/logomark-dark.svg'
import imageHero from './hero.jpg'
import imageDebraFiscal from './debra-fiscal.jpg'

export const caseStudy = {
  client: 'Brandecation',
  title: 'The world’s most customizable training platform',
  description:
    'The all-in-one platform for training, rewards, and incentives – Brandecation offers powerful LMS and dynamic SPIFF management tools, with integrated solutions for rebate programs, contingency, and sponsorship.',
  summary: [
    'Brandecation is a team of Savvy Strategists, Marketing Minds & Industry Changemakers committed to helping boutique fitness business thrive.',
  ...
  image: { src: imageHero },
  date: '2025-02',
  service: 'Website design, development, CMS integration',
  testimonial: {
    author: {
      name: 'Joe Veglatte',
      role: 'Senior Project Manager | Brandecation',
    },
    content:
