import logo from '@/images/clients/craft/logomark-dark.svg'
import imageHero from './hero.jpg'
import imageDebraFiscal from './debra-fiscal.jpg'

export const caseStudy = {
  client: 'Craft & Commerce',
  title: 'This is a sick ass tagline',
  description:
    'Craft & Commerce is a team of Savvy Strategists, Marketing Minds & Industry Changemakers committed to helping boutique fitness business thrive.',
  summary: [
