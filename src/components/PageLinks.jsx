...
function PageLink({ page }) {
  return (
    <article key={page.href}>
      ...
      >
        <h3 className="text-brand-gray mt-6 text-base font-semibold">
          {page.title}
        </h3>
        <time
          dateTime={page.date}
        ...
        <Link
          href={page.href}
          className="text-brand-gray mt-6 flex gap-x-3 text-base font-semibold transition hover:text-neutral-700"
